...
public class MealsUtil {
    ...
    //тестовый список еды
   static List<Meal> testMealsList = Arrays.asList(
    ...
    public static List<Meal> getTestMealsList() {
        return testMealsList;
    }
...
//                      Collectors.toMap(Meal::getDate, Meal::getCalories, Integer::sum)
    ...
    public static List<MealWithExceed> getNotFilteredWithExceeded(List<Meal> meals, int caloriesPerDay) {
        Map<LocalDate, Integer> caloriesSumByDate = meals.stream()
                .collect(
                        Collectors.groupingBy(Meal::getDate, Collectors.summingInt(Meal::getCalories))
//                      Collectors.toMap(Meal::getDate, Meal::getCalories, Integer::sum)
